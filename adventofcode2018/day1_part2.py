...
while found_twice is False:
    
    for change_value in frequency:
        
        if change_value == '':
            starting_frequency += 0
        
        else:
            starting_frequency += int(change_value)

            if starting_frequency in results:
                found_twice = True
                print(starting_frequency)
                break

            else:
                results.append(starting_frequency)
