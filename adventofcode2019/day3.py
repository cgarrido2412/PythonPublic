...
#first test
move_directions_test_1 = ['R75','D30','R83','U83','L12','D49','R71','U7','L72']
...
my_move_directions_1 = []

for item in string1:
    my_move_directions_1.append(item)
...
my_move_directions_2 = []

for item in string2:
    my_move_directions_2.append(item)
