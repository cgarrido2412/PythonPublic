...
first_line = nailed_it(my_move_directions_1)
second_line = nailed_it(my_move_directions_2)
intersections = list(set(first_line) & set(second_line))

def shortest_from_zero():
    length_from_zero = []
