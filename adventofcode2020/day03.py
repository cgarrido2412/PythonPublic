...
if __name__ == "__main__":
    ...
    #Use our tree count function and iterate through all the slopes, multiplying each of our answers together
    for y, x in slopes:
        product *= count_trees(y, x)

    #Our answer for part 2 
    print(product)
